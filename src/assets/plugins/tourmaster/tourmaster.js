(function ($) {
    ...
    $(this).each(function () {
      ...
      if (!$(this).attr("data-tour-date")) {
        ...
        $(this).datepicker({
          ...
          beforeShow: function (input, inst) {
            ...
            if ($("body").hasClass("rtl")) {
              ...
              widget.css(
                "margin-left",
                $(input).outerWidth() - widget.outerWidth()
              );
            }
        ...
        initial_date = new Date(
          initial_date.getTime() + initial_date.getTimezoneOffset() * 60000
        );
  ...
  $.fn.tourmaster_tour_booking = function () {
    ...
    $(this).on(
      "change",
      'input[name="tour-date"], select[name="tour-date"]',
      function () {
    ...
    $(this).on("change", 'select[name="tour-room"]', function () {
      ...
      var template = wrap
        .siblings(".tourmaster-tour-booking-room-template")
        .children();
      var container = wrap.siblings(
      ...
      if ($(this).val() && container.length == 0) {
        var container = $(
          '<div class="tourmaster-tour-booking-people-container" data-step="999" ></div>'
        ).hide();
      ...
      if ($(this).val()) {
        ...
        if (count > 0) {
          for (var i = 0; i < count; i++) {
            ...
            clone
              .find(".tourmaster-tour-booking-room-text > span")
              .html(container.children().length + 1);
          ...
          ajax_url,
          {
            success: function (data) {
              if (typeof data.price != "undefined") {
                ...
                header_price
                  .find(".tourmaster-tour-price-wrap")
                  .removeClass("tourmaster-discount");
                header_price
                  .addClass("tourmaster-price-updated")
                  .find(".tourmaster-tour-price .tourmaster-tail")
                  .html(data.price);
    ...
    $(this).on("click", 'input[type="submit"]', function () {
      ...
      var error_message = $(this).siblings(
      ...
      form
        .find(".tourmaster-extra-booking-field")
      ...
      if (!submit) {
        ...
        tourmaster_tour_booking_ajax(
            ...
            success: function (data) {
              if (data.status == "success") {
                if (submit && submit_button.attr("data-ask-login")) {
                  ...
                  var content = submit_button.siblings(
                    '[data-tmlb-id="' +
                      submit_button.attr("data-ask-login") +
                      '"]'
                  );
                  if (content.length == 0) {
                    content = form
                  ...
                  if (lb_content.find(".nsl-container-block").length > 0) {
                    lb_content
                      ...
                      .replaceWith(
                        content.find(".nsl-container-block").clone(true)
                      );
                  }
                  ...
                  tourmaster_set_cookie(
                    "tourmaster-booking-detail",
                    JSON.stringify(booking_detail),
                    0
                  );
                } else {
                  var booking_detail = tourmaster_get_booking_detail(form);
                ...
                var temp_error = $(
                  '<div class="tourmaster-tour-booking-submit-error tourmaster-temp" ></div>'
                ).html(data.message);
          ...
          },
          {
            ...
            tour_id: form.find('[name="tid"]').val(),
  ...
  $.fn.tourmaster_tour_booking_sticky = function () {
    ...
    $(this).each(function () {
      ...
      var booking_bar_anchor = $(this).siblings(
      ...
      if (page_wrap.hasClass("tourmaster-tour-style-1")) {
        ...
        page_wrap
          .siblings(".tourmaster-single-header")
          .addClass("tourmaster-start-script");

        var header_price = $(this)
          .children(".tourmaster-tour-booking-bar-outer")
          .children(".tourmaster-header-price");
        booking_bar_wrap.css("margin-top", -header_price.outerHeight());
        booking_bar_anchor.css("margin-top", -header_price.outerHeight());
        page_wrap.css(
          "min-height",
          booking_bar_wrap.height() - header_price.outerHeight()
        );
        $(window).resize(function () {
          ...
          booking_bar_wrap.removeClass(
            "tourmaster-fixed tourmaster-top tourmaster-bottom tourmaster-lock"
          );
        });
      }
      ...
      $(window).on("scroll resize", function () {
        ...
        var scroll_direction =
          prev_scroll > $(window).scrollTop() ? "up" : "down";
        prev_scroll = $(window).scrollTop();

        // fixed nav bar
        if (
          animate_on_scroll &&
          $(window).scrollTop() + top_offset + top_padding >
            booking_bar_anchor.offset().top
        ) {
          // bar smaller than screensize
          if (
            $(window).height() >
            booking_bar_wrap.outerHeight() + top_padding
          ) {
            if (
              $(window).scrollTop() +
                booking_bar_wrap.outerHeight() +
                top_offset +
                top_padding * 2 >
              page_wrap.offset().top + page_wrap.outerHeight()
            ) {
              ...
              if ($("body").hasClass("rtl")) {
                booking_bar_wrap.css({
                  ...
                  right:
                    $(window).width() -
                    (booking_bar_anchor.offset().left +
                      booking_bar_anchor.outerWidth()) -
                    right_offset,
                  "margin-top": 0,
                });
              } else {
            ...
            if (scroll_direction == "down") {
              if (booking_bar_wrap.hasClass("tourmaster-top")) {
                if ($("body").hasClass("rtl")) {
                  booking_bar_wrap.css({
                    ...
                    top:
                      ...
                      top_padding +
                      top_offset -
                      booking_bar_wrap.parent().offset().top,
                    right: "auto",
                    "margin-top": 0,
                  });
                } else {
                ...
                $(window).scrollTop() + $(window).height() >
                booking_bar_wrap.offset().top + booking_bar_wrap.outerHeight()
              ) {
                if (!booking_bar_wrap.hasClass("tourmaster-bottom")) {
                  ...
                  booking_bar_wrap.removeClass(
                    "tourmaster-top tourmaster-lock"
                  );
              ...
              if (booking_bar_wrap.hasClass("tourmaster-bottom")) {
                ...
                booking_bar_wrap.hasClass("tourmaster-lock") &&
                $(window).scrollTop() + top_offset + top_padding <
                  booking_bar_wrap.offset().top
              ) {
                if ($("body").hasClass("rtl")) {
                  booking_bar_wrap.css({
                    position: "fixed",
                ...
                booking_bar_wrap.removeClass(
                  "tourmaster-bottom tourmaster-lock"
                );
          ...
          if (
            booking_bar_wrap.hasClass("tourmaster-fixed") ||
            booking_bar_wrap.hasClass("tourmaster-top") ||
            booking_bar_wrap.hasClass("tourmaster-bottom") ||
            booking_bar_wrap.hasClass("tourmaster-lock")
          ) {
            if ($("body").hasClass("rtl")) {
              booking_bar_wrap.css({
  ...
  tourmaster_payment_template.prototype = {
    init: function () {
      ...
      t.form.on("click", ".tourmaster-payment-step", function () {
        ...
        if ($(this).attr("data-name")) {
          booking_detail_data[$(this).attr("data-name")] =
      ...
      t.form.on(
        "change input",
        ".tourmaster-payment-service-form-wrap input",
        tourmaster_debounce(function (e) {
          if (e.type == "change" && $(e.target).is('input[type="text"]'))
            return;
      ...
      t.form.on("change", 'input[name="payment-type"]', function () {
        var total_price_wrap = $(this).closest(
          ".tourmaster-tour-booking-bar-total-price-wrap"
        );
        var deposit_price_wrap = total_price_wrap.siblings(
    ...
    bind_script_recurring: function () {
      ...
      t.content.find("#tourmaster-payment-method-or").each(function () {
        var divider_width =
          ($(this).width() -
            $(this).children(".tourmaster-middle").width() -
            40) /
          2;
        $(this)
          .children(".tourmaster-left, .tourmaster-right")
    ...
    bind_script: function () {
      ...
      t.sidebar.on(
        ...
        function () {
          ...
          temp_form.append(
            $('<input name="tour_temp" />').val(JSON.stringify(booking_detail))
          );
          temp_form.submit();
        }
      );
      ...
      t.sidebar.on(
        ...
        function () {
          ...
          var coupon_message = $(this).siblings(
          ...
          $.ajax({
            ...
            beforeSend: function () {
              ...
              coupon_message.removeClass(
                "tourmaster-success tourmaster-failed"
              );
            },
            error: function (jqXHR, textStatus, errorThrown) {
              // print error message for debug purpose
      ...
      t.content.on("click", "#tourmaster-payment-billing-copy", function () {
        if ($(this).is(":checked")) {
          var billing_info = $(this).closest(
            ".tourmaster-payment-billing-wrap"
          );
          var contact_info = billing_info.siblings(
            ".tourmaster-payment-contact-wrap"
          );

          billing_info.find("[data-contact-detail]").each(function () {
            var contact_field = contact_info.find(
              '[name="' + $(this).attr("data-contact-detail") + '"]'
            );
      ...
      var ajax_settings = $.extend(
        {
          beforeSend: function () {
            // loading animation
            if (
              typeof ajax_data.sub_action == "undefined" ||
              ajax_data.sub_action != "update_sidebar"
            ) {
          ...
          success: function (data) {
            ...
            // set the step bar
            if (
              typeof ajax_data.booking_detail != "undefined" ||
              typeof ajax_data.step != "undefined"
            ) {
              ...
              t.payment_step
                .find(".tourmaster-payment-step-item")
                .each(function () {
                  if (booking_step == 4) {
                    $(this)
                      .addClass("tourmaster-checked")
                      .removeClass("tourmaster-current tourmaster-enable");
                  } else {
                    if ($(this).attr("data-step") == 1) {
                      $(this)
                        .addClass("tourmaster-checked")
                      ...
                      $(this)
                        .addClass("tourmaster-current")
                        .removeClass("tourmaster-checked tourmaster-enable");
                    } else if ($(this).attr("data-step") < booking_step) {
                      $(this)
                        .addClass("tourmaster-enable")
                        .removeClass("tourmaster-checked tourmaster-current");
                    } else {
                      $(this).removeClass(
                        "tourmaster-checked tourmaster-current tourmaster-enable"
                      );
                    }
                  }
                });
  ...
  $(document).ready(function () {
    ...
    $(".tourmaster-center-tour-content").each(function () {
      var left_height = $(this)
        .siblings(".tourmaster-content-left")
        .outerHeight();
    ...
    if (search_item.length) {
      ...
      search_item.find(".tourmaster-type-filter-title i").click(function () {
        var filter_content = $(this)
          .parent()
          .siblings(".tourmaster-type-filter-item-wrap");
    ...
    if (body.hasClass("single-tour")) {
      ...
      $(".tourmaster-single-tour-read-more-wrap .tourmaster-button").on(
        "click",
        function () {
          var scrollPos = $(window).scrollTop();
          ...
          $(this)
            .parent()
            .parent()
            .siblings(".tourmaster-single-tour-read-more-gradient")
            .hide();
          $(this)
            .closest(".tourmaster-single-tour-content-wrap")
            .css({ "max-height": "none", "margin-bottom": 0 });
      ...
      // combobox list
      $(".tourmaster-single-tour-booking-fields").on(
        "click",
      ...
      $(".tourmaster-single-tour-booking-fields").on(
        ...
        function () {
          ...
          $(this)
            .closest("ul")
            .siblings(".tourmaster-combobox-list-display")
            .children("span")
            .html(value);
        }
      );
      ...
      $("#tourmaster-booking-tab-title")
        ...
        .click(function () {
          ...
          $(this)
            .parent()
            .siblings(".tourmaster-booking-tab-content")
            .each(function () {
  ...
  $(window).load(function () {
    ...
    if (!body.is(".wp-admin") && content_nav.length) {
      ...
      content_nav.each(function () {
        $(this)
          .find(".tourmaster-content-navigation-tab")
          .hover(
            function () {
              slidebar.animate(
            ...
            function () {
              var active_slidebar = $(this)
                .parent()
                .children(".tourmaster-slidebar-active");
  ...
  (d.prototype = {
    show: function () {
      ...
      if (c && this.enabled) {
        ...
        var i,
          e = a.extend({}, this.$element.offset(), {
        ...
        2 == h.length &&
          ...
          (d.find(".tipsy-arrow")[0].className =
            "tipsy-arrow tipsy-arrow-" + h.charAt(0)),
    ...
    fixTitle: function () {
      var a = this.$element;
      (a.attr("title") || "string" != typeof a.attr("original-title")) &&
    ...
    getTitle: function () {
      ...
      return (
        "string" == typeof c.title
          ? (a = b.attr("title" == c.title ? "original-title" : c.title))
          : "function" == typeof c.title && (a = c.title.call(b[0])),
        (a = ("" + a).replace(/(^\s*|\s*$)/, "")),
        a || c.fallback
      );
    },
    ...
    (a.fn.tipsy.autoBounds = function (b, c) {
      return function () {
        var d = { ns: c[0], ew: c.length > 1 && c[1] },
          e = a(document).scrollTop() + b,
          f = a(document).scrollLeft() + b,
          g = a(this);
        return (
          g.offset().top < e && (d.ns = "n"),
          g.offset().left < f && (d.ew = "w"),
          a(window).width() + a(document).scrollLeft() - g.offset().left < b &&
            (d.ew = "e"),
          a(window).height() + a(document).scrollTop() - g.offset().top < b &&
            (d.ns = "s"),
          d.ns + (d.ew ? d.ew : "")
        );
      };
