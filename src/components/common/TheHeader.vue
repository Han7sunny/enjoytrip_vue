<template>
  <div>
    <div class="traveltour-top-bar traveltour-with-divider">
      ...
      <div
        class="traveltour-top-bar-container clearfix traveltour-top-bar-full"
      >
        <div class="traveltour-top-bar-left traveltour-item-pdlr">
          <i
            class="fa fa-phone"
            style="font-size: 16px; color: #94999f; margin-right: 10px"
          ></i>
          1.820.3345.33
          <i
        ...
        <div class="traveltour-top-bar-right traveltour-item-pdlr">
          ...
          <div class="tourmaster-user-top-bar tourmaster-guest">
            <a class="tourmaster-user-top-bar-login" href="#"
              ><i class="icon_lock_alt"></i
              ><span class="tourmaster-text">Login</span></a
            ><a class="tourmaster-user-top-bar-signup" href="#"
              ><i class="fa fa-user"></i
              ><span class="tourmaster-text">Sign Up</span></a
            >
          </div>
        </div>
      </div>
    ...
    <header
      class="traveltour-header-wrap traveltour-header-style-plain traveltour-style-menu-right traveltour-sticky-navigation traveltour-style-fixed"
    >
              ...
              <ul id="menu-main-navigation-1" class="sf-menu">
                ...
                >
                  ...
                  <!-- <ul class="sub-menu">
                      ...
                      <ul class="sub-menu">
                        <li class="menu-item menu-item-has-children">
                          ...
                          <ul class="sub-menu">
                            ...
                            <li class="menu-item">
                              <a href="column-services.html">Column Services</a>
                            </li>
                            <li class="menu-item">
                        ...
                        <li class="menu-item menu-item-has-children">
                          ...
                          <ul class="sub-menu">
                            ...
                            <li class="menu-item">
                              <a href="tabs-horizontal.html">Tabs Horizontal</a>
                            </li>
                            <li class="menu-item">
                    ...
                    <li class="menu-item menu-item-has-children" data-size="60">
                      <a href="#" class="sf-with-ul-pre">Contact</a>
                      <ul class="sub-menu">
                        <li class="menu-item">
                    ...
                    <li class="menu-item menu-item-has-children" data-size="60">
                      <a href="portfolio-3-columns.html" class="sf-with-ul-pre"
                        >Portfolio</a
                      >
                      <ul class="sub-menu">
                        <li class="menu-item menu-item-has-children">
                        ...
                        <li class="menu-item menu-item-has-children">
                          ...
                          <ul class="sub-menu">
                            ...
                            <li class="menu-item">
                              <a href="portfolio-modern-2-columns-no-space.html"
                                >Modern 2 Columns No Space</a
                              >
                            </li>
                            <li class="menu-item">
                              <a href="portfolio-modern-3-columns-no-space.html"
                                >Modern 3 Columns No Space</a
                              >
                            </li>
                            <li class="menu-item">
                              <a href="portfolio-modern-4-columns-no-space.html"
                                >Modern 4 Columns No Space</a
                              >
                            </li>
                            <li class="menu-item">
                              <a href="portfolio-modern-5-columns-no-space.html"
                          ...
                          <ul class="sub-menu">
                            <li class="menu-item">
                              <a
                                ...
                                >Portfolio Left &#038; Right Large Thumbnail</a
                              >
                            </li>
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                              <a
                                ...
                                >Portfolio Left &#038; Right Small Thumbnail</a
                              >
                            </li>
                            <li class="menu-item">
                    ...
                    <li class="menu-item menu-item-has-children" data-size="60">
                      <a href="#" class="sf-with-ul-pre">Team</a>
                      <ul class="sub-menu">
                        <li class="menu-item">
                          <a href="team-plain-style.html">Team / Plain Style</a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                          <a href="team-frame-style.html">Team / Frame Style</a>
                        </li>
                      </ul>
                    </li>
                  ...
                  <!-- <ul class="sub-menu">
                    <li class="menu-item menu-item-has-children" data-size="60">
                      ...
                      <ul class="sub-menu">
                        ...
                        <li class="menu-item">
                          <a href="tour-full-with-frame-left-sidebar.html"
