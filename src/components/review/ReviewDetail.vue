<template>
  <div class="traveltour-page-wrapper" id="traveltour-page-wrapper">
                <div class="traveltour-blog-title-wrap  traveltour-style-custom traveltour-feature-image" style="background-image: url(upload/photo-1442589031151-61d5645469d7.jpg) ;">
                        ...
                        <div class="traveltour-blog-title-content traveltour-item-pdlr" style="padding-top: 400px ;padding-bottom: 80px ;">
                            <header class="traveltour-single-article-head clearfix">
                                ...
                                <div class="traveltour-single-article-head-right">
                                    ...
                                    <h1 class="traveltour-single-article-title">{{review.title}}</h1>
            ...
            <a
              ...
              " v-if="reviewModify"
              ><router-link :to="{name:'reviewModify', params:{review : this.review, location : this.location}}"><span class="gdlr-core-content">여행 후기 글 수정하기</span
              ><i
                                    ...
                                    <article id="post-1268" class="post-1268 post type-post status-publish format-standard has-post-thumbnail hentry category-blog category-post-format category-uncategorized tag-news">
                                        <div class="traveltour-single-article">
                                            <div class="traveltour-single-article-content">
                                                ...
                                                <blockquote>
                                                    <p>I sink under the weight of the splendour of these visions!A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which</p>
                                                </blockquote>
                                                ...
                                                <p>
                                                    <a href="upload/shutterstock_245507692.jpg"><img class="alignnone size-full wp-image-4508" src="upload/shutterstock_245507692.jpg" alt="" width="1800" height="1200" /></a>
                                    ...
                                    <div class="traveltour-single-social-share traveltour-item-rvpdlr">
                                        <div class="gdlr-core-social-share-item gdlr-core-item-pdb  gdlr-core-center-align gdlr-core-social-share-left-text gdlr-core-item-pdlr gdlr-core-style-plain" style="padding-bottom: 0px ;">
                                            <span class="gdlr-core-social-share-count gdlr-core-skin-title">
                                                <span class="gdlr-core-suffix">조회수</span>
                                                <span class="gdlr-core-count" >{{review.hits}}</span>
...
export default {
    ...
    created(){
        ...
        // 지도 출력하기 위한 contentId로의 content 조회 필요 -> 여기서 location 객체 만들어서 modify에도 넘겨줌
        // 로그인한 회원의 userId와 해당 게시글의 userId 동일할 경우 reviewModify true로 갱신
    }
}
</script>
