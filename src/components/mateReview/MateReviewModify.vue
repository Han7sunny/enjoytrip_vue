...
export default {
    ...
    created(){
        ...
        // this.mateReview = this.$route.params.mateReview; // for modify

        // getPost(2, this.$route.params.postId,
        //     ({data}) => {
        //         this.mateReview = data;
        //     },(error) => {
